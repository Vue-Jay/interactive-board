...
export default function BoardVideoCallPanel({boardId,userId,participants}:Props){
 ...
 const [position,setPosition]=useState<Position|null>(null),[iceMode,setIceMode]=useState<BoardCallIceMode|null>(null),[connectionRoute,setConnectionRoute]=useState<ConnectionRoute>("unknown"),[remoteVideoActive,setRemoteVideoActive]=useState(false),[callSeconds,setCallSeconds]=useState(0);
